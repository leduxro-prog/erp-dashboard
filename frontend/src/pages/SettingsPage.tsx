  ...
  const renderContent = () => {
    if (loading)
      return (
        <div className="p-8 text-center">
          ...
          <span className="text-gray-500 mt-2 block">Loading settings...</span>
        </div>
      );
    ...
    switch (activeTab) {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('general', 'vatRate', parseFloat(e.target.value) / 100)
                    }
                    className={`w-full p-2 rounded-lg border ${isDark ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200'} focus:ring-2 focus:ring-blue-500 outline-none`}
                  />
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      aria-label="Afișare Prețuri"
                      checked={settings.b2b?.showPrices}
                      onChange={(e) => handleChange('b2b', 'showPrices', e.target.checked)}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      aria-label="Afișare Stocuri"
                      checked={settings.b2b?.showStock}
                      onChange={(e) => handleChange('b2b', 'showStock', e.target.checked)}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                  </label>
                ...
                <div className="flex items-center justify-between">
                  <span className={`text-sm ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    Permite Înregistrare Clienți Noi
                  </span>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      aria-label="Permite Înregistrare Clienți Noi"
                      checked={settings.b2b?.allowRegistration}
                      onChange={(e) => handleChange('b2b', 'allowRegistration', e.target.checked)}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                  </label>
                ...
                <div className="flex items-center justify-between">
                  <span className={`text-sm ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    Aprobare Automată Clienți Noi
                  </span>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      aria-label="Aprobare Automată Clienți Noi"
                      checked={settings.b2b?.autoApprove}
                      onChange={(e) => handleChange('b2b', 'autoApprove', e.target.checked)}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                  </label>
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
                    Sincronizare Facturare & Contabilitate
                  </p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label
                    htmlFor="sb-username"
                    className="block text-xs font-medium mb-1 uppercase text-gray-500"
                  >
                    Utilizator / Email
                  </label>
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('integrations', 'username', e.target.value, 'smartbill')
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('integrations', 'token', e.target.value, 'smartbill')
                    }
                    className={`w-full p-2 text-sm rounded border ${isDark ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200'} focus:ring-1 focus:ring-blue-500 outline-none`}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('integrations', 'cif', e.target.value, 'smartbill')
                    }
                    className={`w-full p-2 text-sm rounded border ${isDark ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200'} focus:ring-1 focus:ring-blue-500 outline-none`}
                  />
                </div>
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
                    Integrare platformă e-commerce
                  </p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('integrations', 'url', e.target.value, 'woocommerce')
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('integrations', 'consumerKey', e.target.value, 'woocommerce')
                    }
                    className={`w-full p-2 text-sm rounded border ${isDark ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200'} focus:ring-1 focus:ring-blue-500 outline-none`}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('integrations', 'consumerSecret', e.target.value, 'woocommerce')
                    }
                    className={`w-full p-2 text-sm rounded border ${isDark ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200'} focus:ring-1 focus:ring-blue-500 outline-none`}
                  />
                </div>
                      ...
                      >
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div
                              className={`h-8 w-8 rounded-full flex items-center justify-center mr-3 ${isDark ? 'bg-gray-700 text-gray-300' : 'bg-blue-100 text-blue-600'}`}
                            >
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleChange('security', 'jwt', {
                        ...settings.security?.jwt,
                        accessTokenExpiry: e.target.value,
                      })
                    }
                    className={`w-full p-2 rounded-lg border ${isDark ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200'} focus:ring-2 focus:ring-blue-500 outline-none`}
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleChange('security', 'jwt', {
                        ...settings.security?.jwt,
                        refreshTokenExpiry: e.target.value,
                      })
                    }
                    className={`w-full p-2 rounded-lg border ${isDark ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200'} focus:ring-2 focus:ring-blue-500 outline-none`}
                  >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('security', 'password', {
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange('security', 'twoFactor', {
                ...
                <div className="flex items-center justify-between">
                  <span className={`text-sm ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    Obligă pentru Administratori (Recomandat)
                  </span>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('security', 'accountLockout', {
                        ...settings.security?.accountLockout,
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange('security', 'auditLogging', {
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('notifications', 'email', {
                        ...settings.notifications?.email,
                        smtp: { ...settings.notifications?.email?.smtp, username: e.target.value },
                      })
                    }
                    className={`w-full p-2 rounded-lg border ${isDark ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200'} focus:ring-2 focus:ring-blue-500 outline-none`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('notifications', 'email', {
                        ...settings.notifications?.email,
                        smtp: { ...settings.notifications?.email?.smtp, password: e.target.value },
                      })
                    }
                    className={`w-full p-2 rounded-lg border ${isDark ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200'} focus:ring-2 focus:ring-blue-500 outline-none`}
                  />
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('notifications', 'email', {
                        ...settings.notifications?.email,
                        smtp: { ...settings.notifications?.email?.smtp, from: e.target.value },
                      })
                    }
                    className={`w-full p-2 rounded-lg border ${isDark ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200'} focus:ring-2 focus:ring-blue-500 outline-none`}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange('notifications', 'sms', {
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleChange('notifications', 'sms', {
                        ...settings.notifications?.sms,
                        provider: e.target.value as 'twilio' | 'vonage' | 'custom',
                      })
                    }
                    className={`w-full p-2 rounded-lg border ${isDark ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200'} focus:ring-2 focus:ring-blue-500 outline-none`}
                  >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange('notifications', 'inApp', {
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange('notifications', 'quietHours', {
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange('system', 'performance', {
                          ...settings.system?.performance,
                          caching: {
                            ...settings.system?.performance?.caching,
                            enabled: e.target.checked,
                          },
                        })
                      }
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleChange('system', 'performance', {
                          ...settings.system?.performance,
                          rateLimit: {
                            ...settings.system?.performance?.rateLimit,
                            enabled: e.target.checked,
                          },
                        })
                      }
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange('system', 'monitoring', {
      ...
      default:
        return (
          <div
            className={`p-12 rounded-xl border text-center ${isDark ? 'bg-gray-800/30 border-gray-700' : 'bg-white border-gray-200 border-dashed'}`}
          >
            <Lock
              size={48}
    ...
    <div className="flex flex-col md:flex-row gap-8 h-full">
      ...
      {isUserModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div
            className={`w-full max-w-md p-6 rounded-xl shadow-2xl ${isDark ? 'bg-gray-900 border border-gray-700' : 'bg-white'}`}
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="new-email" className="block text-sm font-medium mb-1 text-gray-500">
                  Email
                </label>
                <input
                  id="new-email"
              ...
              <div>
                <label htmlFor="new-role" className="block text-sm font-medium mb-1 text-gray-500">
                  Rol
                </label>
                <select
                  id="new-role"
